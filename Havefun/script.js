...
// Clear container and show "I'm not a robot"
robotLink.addEventListener('click', function() {
    gameContainer.innerHTML = '<p>🤖 You are not a robot! ✅</p>';
});

// Clear container and show Clicker Game
...
// Clear container and show Spend $100M game
spendLink.addEventListener('click', function() {
    gameContainer.innerHTML = `
        <p>Try to spend $100,000,000!</p>
        <button id="spend-button">Spend $1,000,000</button>
